...
public class TestScoreCard
{
    ...
    public void numberOfCategoriesFilled()
    {
        ...
        boolean success1=scoreCard.fillCategory(CategoryType.ONES, new int[]
        { 1, 1, 1, 1, 1 });
        assertTrue(success1);
        boolean success2=scoreCard.fillCategory(CategoryType.FOURS, new int[]
        { 4, 4, 4, 4, 4 });
        assertTrue(success2);
        scoreCard.fillCategory(CategoryType.SMALL_STRAIGHT, new int[]
        { 1, 2, 3, 4, 6 });
    ...
    public void getCategoryTest()
    {
        ...
        Assert.assertTrue( value == Category.NO_VALUE );
